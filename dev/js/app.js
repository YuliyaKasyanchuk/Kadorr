(function () {
	...
	setLogoClickEvent();
	setItemThumbsClickEvent();

})();


function setItemThumbsClickEvent() {
	var all_thumbs = document.getElementsByClassName("catalogue__thumbs-item");

	for (var i = 0; i < all_thumbs.length; i++) {
		all_thumbs[i].addEventListener("click", function(e) {
			e.preventDefault();

			if ( !this.className.includes('active-thumb-item') ) {
				document.getElementsByClassName('active-catalogue-item')[0].className = 'row catalogue__item';
				document.getElementsByClassName('active-thumb-item')[0].className = 'catalogue__thumbs-item';
				
				var cat_item = document.querySelectorAll('[data-catalogueitem=' + this.dataset.thumbitem + ']')[0];
				
				cat_item.className = 'row catalogue__item active-catalogue-item';
				this.className = 'catalogue__thumbs-item active-thumb-item';
			}
...
function setLogoClickEvent(){
	var manufacturer_logos = document.getElementsByClassName("manufacturer__logo");

	for (var i = 0; i < manufacturer_logos.length; i++) {
		manufacturer_logos[i].addEventListener("click", function(e) {
			e.preventDefault();

			if ( !this.className.includes('active-logo') ) {
				document.getElementsByClassName('active-text')[0].className = 'manufacturer__text';
				document.getElementsByClassName('active-logo')[0].className = 'manufacturer__logo';
				
				var manuf_text = document.querySelectorAll('[data-manufname=' + this.dataset.logo + ']')[0];
				manuf_text.className = 'manufacturer__text active-text';
				this.className = 'manufacturer__logo active-logo';
			}
